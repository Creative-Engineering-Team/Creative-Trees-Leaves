...
public class ItemInit {
    ...
    public static final Supplier<Item> PLIABLE_BRANCH = ITEMS.register("pliable_branch",()->new pliableBrancheItem(new Item.Properties()));
    public static final Supplier<Item> DRY_PLIABLE_BRANCH = ITEMS.register("dry_pliable_branch",()->new dryPliableBrancheItem(new Item.Properties()));
}
